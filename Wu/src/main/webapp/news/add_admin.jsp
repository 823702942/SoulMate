			...
			<tr>
				<td valign="top" colspan="2">
					<table cellspacing="0" cellpadding="0" width="100%" align="center"
							...
							<td colspan="2">
								<table width="100%" border="0" cellpadding="0" cellspacing="0"
									...
									<tr>
										...
										<td style="width: 30%">
										<select name="xq" onchange="javascript:setTimeout(&#39;__doPostBack(\&#39;xq\&#39;,\&#39;\&#39;)&#39;, 0)"
									...
									<tr>
										...
										<td><select name="dy" onchange="javascript:setTimeout(&#39;__doPostBack(\&#39;dy\&#39;,\&#39;\&#39;)&#39;, 0)"
											id="dy" class="mytext" style="width: 90%;">

										</select></td>
										<td class="form-item"><font color="red">*</font>房间名称：</td>
									...
									<tr>
										...
										<td>
										<input name="sqdate" type="text" maxlength="10" id="sqdate" class="mytext"
									...
									<tr>
										<td class="form-item"><font color="red">*</font>装修内容：</td>
										<td colspan="3"><textarea name="zxnr" rows="3" cols="20"
												id="zxnr" class="mytextarea" style="width: 96%;"></textarea>
										</td>
									</tr>
								</table>
							</td>
						...
						<tr>
							<td colspan="2" align="center" style="height: 30px"><input
								type="submit" name="SaveAddBtn" value="保存并新建"
								onclick="javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;SaveAddBtn&quot;, &quot;&quot;, true, &quot;&quot;, &quot;&quot;, false, false))"
								id="SaveAddBtn" class="mybtn" /> <input type="submit"
								name="SaveBtn" value=" 保存 "
...
var Page_Validators =  new Array(document.getElementById("Requiredfieldvalidator1"),
		...
		document.getElementById("Requiredfieldvalidator8"),
