...
Calendar.prototype.draw = function () {
    ...
    obj.onclick = function () {
        ...
        var today = (calendar.DateMode != pickMode["day"]) ?
                     new Date(calendar.year, calendar.month, calendar.day, calendar.hour, calendar.minute, calendar.second): new Date();
...
Calendar.prototype.show = function (dateObj, popControl) {
 ...
 {calendar.onblur();if(typeof(this.blurEvent) =='function'){
	 this.blurEvent();
	 }
 }
  }
